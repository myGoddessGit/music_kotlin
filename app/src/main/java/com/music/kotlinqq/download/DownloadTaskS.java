...
public class DownloadTaskS extends AsyncTask<DownloadInfo, DownloadInfo, Integer> {
    ...
    public DownloadTaskS(DownloadListener downloadListener) {
    ...
    protected Integer doInBackground(DownloadInfo... downloadInfos) {
        ...
        try {
            ...
            String fileName = DownloadUtil.Companion.getSaveSongFile(downloadInfo.getSinger(),downloadInfo.getSongName(),downloadInfo.getDuration(),downloadInfo.getSongId(),contentLength);
