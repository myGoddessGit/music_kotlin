...
public class DiscViewS extends RelativeLayout {
    ...
    public DiscViewS(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DiscViewS(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        mScreenWidth = CommonUtil.Companion.getScreenWidth(context);
        mScreenHeight = CommonUtil.Companion.getScreenHeight(context);
    }
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (mIsNeed2StartPlayAnimator) {
                    ...
                    if (!mViewPagerIsOffset) {
                        /*延时500ms*/
                        DiscViewS.this.postDelayed(new Runnable() {
                            @Override
                            public void run() {
                                playAnimator();
                            }
