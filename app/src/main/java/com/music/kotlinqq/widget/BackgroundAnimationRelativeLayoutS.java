 ...
 * */
public class BackgroundAnimationRelativeLayoutS extends RelativeLayout {
    ...
    public BackgroundAnimationRelativeLayoutS(Context context) {
        this(context, null);
    }

    public BackgroundAnimationRelativeLayoutS(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public BackgroundAnimationRelativeLayoutS(Context context, AttributeSet attrs, int
            defStyleAttr) {
    ...
    private void initObjectAnimator() {
        ...
        objectAnimator.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() {
            ...
            public void onAnimationUpdate(ValueAnimator animation) {
                ...
                BackgroundAnimationRelativeLayoutS.this.setBackground(layerDrawable);
            }
        });
