package com.music.kotlinqq.app;
...
public class Api {
     ...
     * 存取到手机内存的文件名
     */
    public static String STORAGE_IMG_FILE= App.getContext().getExternalFilesDir("") + "/yearling/img/";
    public static String STORAGE_LRC_FILE= App.getContext().getExternalFilesDir("") + "/yearling/lrc/";
